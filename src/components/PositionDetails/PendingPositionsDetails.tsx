    ...
    <>
      {position && (
        <FlexContainer
          ...
          width="100%"
        >
          {position && <InstrumentMarkets instrument={instrumentsStore.instruments.find(item => item.instrumentItem.id === position.instrument)?.instrumentItem || instrumentsStore.instruments[0].instrumentItem} />}
