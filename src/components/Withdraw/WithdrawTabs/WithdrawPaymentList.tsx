...
const WithdrawPaymentList = () => {
  ...
  return (
    <FlexContainer flexDirection="column" width="100%">
      <PaymentLink to={Page.ACCOUNT_WITHDRAW_NEW_BANKTRANSFER}>
        <FlexContainer
          height="80px"
          minHeight="80px"
          padding="16px"
        ...
        >
          <FlexContainer>
          <FlexContainer width="48px" height="48px" borderRadius="50%" backgroundColor="#494c53" justifyContent="center" alignItems="center">
      ...
      <PaymentLink to={Page.ACCOUNT_WITHDRAW_NEW_BITCOIN}>
        <FlexContainer
          height="80px"
          minHeight="80px"
          padding="16px"
